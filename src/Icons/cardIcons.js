...
const LikeButtonWrapper = styled(ButtonWrapper)`
...
export const LikeButton = () => {
  ...
  return (
    <LikeButtonWrapper onClick={handleOnClick}>{renderSvg()}</LikeButtonWrapper>
  );
};
...
export const BookmarkButton = () => {
  ...
  return <ButtonWrapper onClick={handleOnClick}>{renderSvg()}</ButtonWrapper>;
};
